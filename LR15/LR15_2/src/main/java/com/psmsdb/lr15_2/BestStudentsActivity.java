...
public class BestStudentsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected ArrayList<String> getFacultys() {
        ...
        String query = "select FACULTY_TABLE.FACULTY as faculty from FACULTY_TABLE";
